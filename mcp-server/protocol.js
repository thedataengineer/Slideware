...
const TOOLS = [
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        sameFont: { type: "boolean" },
        sameFontColor: { type: "boolean" },
        sameFontSize: { type: "boolean" },
      },
      additionalProperties: false,
    },
  },
  ...
  {
    name: "replace_fonts",
    description: "Replace every use of one font family with another across the whole deck.",
    inputSchema: {
      type: "object",
